...
%w(Sunday Monday Tuesday Wednesday Thursday Friday Saturday).each_with_index do |day, index|
  Day.create(id: index, name: day) unless Day.find_by(name: day)
end
puts "Days Seeded."

# Moves
air_squat = Move.create(name: 'Air Squat', url: '<iframe width="560" height="315" src="https://www.youtube.com/embed/R0vJBTrzLac" frameborder="0" allowfullscreen></iframe>')
burpee = Move.create(name: 'Burpee', url: '<iframe width="560" height="315" src="https://www.youtube.com/embed/tJrdJBWBu08" frameborder="0" allowfullscreen></iframe>')
situp = Move.create(name: 'Situp', url: '<iframe width="560" height="315" src="https://www.youtube.com/embed/1fbU_MkV7NE" frameborder="0" allowfullscreen></iframe>')
push_up = Move.create(name: 'Push Up', url: '<iframe width="560" height="315" src="https://www.youtube.com/embed/eFOSh8vpd6I" frameborder="0" allowfullscreen></iframe>')
...
the_dip = Move.create(name: 'The Dip', url: '<iframe width="560" height="315" src="<iframe width="560" height="315" src="https://www.youtube.com/embed/E-KuVYFtMfU" frameborder="0" allowfullscreen></iframe>')
...
# O.Zone Challenge
ozone_challenge = Workout.create(min_time: 90, rounds: 1)
