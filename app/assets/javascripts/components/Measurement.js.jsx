class Measurement extends React.Component{
  ...
  render() {
    return(
      <tr>
        <td>{this.props.measurement.ozone_challenge}</td>
        ...
        <td>{this.props.measurement.right_bicep}</td>
        <td>{this.props.measurement.left_bicep}</td>
        <td>{this.props.measurement.right_thigh}</td>
        <td>{this.props.measurement.left_thigh}</td>
        <td>{this.props.measurement.waist}</td>
        <td>{this.props.measurement.right_calf}</td>
